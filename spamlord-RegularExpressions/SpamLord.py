...
epatterns.append('([A-Za-z.]+)\s?&#x40;\s*([A-Za-z.]+)\.edu')
epatterns.append('([A-Za-z.]+)\s[A-Z]+\s([A-Za-z.]+)\s[A-Za-z]+\sedu')
epatterns.append('([A-Za-z.]+)\s*<del>\@\s*([a-z.]+)\.edu')
epatterns.append('([A-Za-z.]+)\s*<at symbol>\s*([a-z.]+)\.edu')
...
ppatterns.append('\s?\+1\s?(\d{3})\s?-?(\d{3})\s?-?(\d{4})')
ppatterns.append('\s?\((\d{3})\)\s?(\d{3})-(\d{4})')
ppatterns.append('\s?\[(\d{3})\]\s?(\d{3})-(\d{4})')
